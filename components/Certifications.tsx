          ...
          {certificationsData.map((cert) => (
            ...
            >
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                {/* Logo */}
                <div className="flex-shrink-0 relative w-16 h-16 rounded-lg overflow-hidden bg-white p-2 border border-gray-100 dark:border-gray-700">
                  <Image
                    src={cert.logo ? cert.logo.replace(/ /g, "%20") : "/placeholder.svg"}
                    alt={cert.issuer}
                    fill
                    sizes="64px"
